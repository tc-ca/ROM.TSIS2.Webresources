...
interface ts_trip_Select {
  ...
  ts_program: WebAttribute<ts_trip_Select, { ts_program: ts_program | null }, { ts_program_formatted?: string }>;
...
interface ts_trip_Expand {
  ...
  owningbusinessunit: WebExpand<ts_trip_Expand, BusinessUnit_Select, BusinessUnit_Filter, { owningbusinessunit: BusinessUnit_Result }>;
  ...
  ts_trip_Emails: WebExpand<ts_trip_Expand, Email_Select, Email_Filter, { ts_trip_Emails: Email_Result[] }>;
