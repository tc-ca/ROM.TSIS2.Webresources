...
interface ts_OperationActivityRiskScores_Select {
  ...
  ts_usesprescribedfrequencyoverride: WebAttribute<ts_OperationActivityRiskScores_Select, { ts_usesprescribedfrequencyoverride: boolean | null }, {  }>;
...
interface ts_OperationActivityRiskScores_Filter {
  ...
  ts_usesprescribedfrequencyoverride: boolean;
...
interface ts_OperationActivityRiskScores_Expand {
  ...
  owningbusinessunit: WebExpand<ts_OperationActivityRiskScores_Expand, BusinessUnit_Select, BusinessUnit_Filter, { owningbusinessunit: BusinessUnit_Result }>;
