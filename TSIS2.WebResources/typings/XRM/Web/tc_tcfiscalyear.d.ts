...
interface tc_TCFiscalYear_Relationships {
  ...
  ts_dutyinspectorschedule_FiscalYear_tc_tcfiscalyear?: ts_DutyInspectorSchedule_Result[] | null;
  ...
  ts_unplannedworkorder_PlannedFiscalYear_tc_tcfiscalyear?: ts_unplannedworkorder_Result[] | null;
}
...
interface tc_TCFiscalYear_Expand {
  ...
  ts_dutyinspectorschedule_FiscalYear_tc_tcfiscalyear: WebExpand<tc_TCFiscalYear_Expand, ts_DutyInspectorSchedule_Select, ts_DutyInspectorSchedule_Filter, { ts_dutyinspectorschedule_FiscalYear_tc_tcfiscalyear: ts_DutyInspectorSchedule_Result[] }>;
  ...
  ts_unplannedworkorder_PlannedFiscalYear_tc_tcfiscalyear: WebExpand<tc_TCFiscalYear_Expand, ts_unplannedworkorder_Select, ts_unplannedworkorder_Filter, { ts_unplannedworkorder_PlannedFiscalYear_tc_tcfiscalyear: ts_unplannedworkorder_Result[] }>;
}
...
interface tc_TCFiscalYear_RelatedMany {
  ...
  ts_dutyinspectorschedule_FiscalYear_tc_tcfiscalyear: WebMappingRetrieve<ts_DutyInspectorSchedule_Select,ts_DutyInspectorSchedule_Expand,ts_DutyInspectorSchedule_Filter,ts_DutyInspectorSchedule_Fixed,ts_DutyInspectorSchedule_Result,ts_DutyInspectorSchedule_FormattedResult>;
  ...
  ts_unplannedworkorder_PlannedFiscalYear_tc_tcfiscalyear: WebMappingRetrieve<ts_unplannedworkorder_Select,ts_unplannedworkorder_Expand,ts_unplannedworkorder_Filter,ts_unplannedworkorder_Fixed,ts_unplannedworkorder_Result,ts_unplannedworkorder_FormattedResult>;
}
