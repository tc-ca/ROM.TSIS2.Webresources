...
interface Post_Create extends Post {
  ...
  regardingobjectid_ts_unplannedworkorder_bind$ts_unplannedworkorders?: string | null;
}
...
interface Post_Expand {
  ...
  regardingobjectid_ts_unplannedworkorder: WebExpand<Post_Expand, ts_unplannedworkorder_Select, ts_unplannedworkorder_Filter, { regardingobjectid_ts_unplannedworkorder: ts_unplannedworkorder_Result }>;
}
