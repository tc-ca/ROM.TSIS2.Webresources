...
interface ovs_operation_Relationships {
  ...
  ts_File_ovs_operation_ovs_operation?: ts_File_Result[] | null;
  ...
  ts_operationriskassessment_operation?: ts_operationriskassessment_Result[] | null;
  ...
  ts_ovs_operation_ts_unplannedworkorder_ts_unplannedworkorder?: ts_unplannedworkorder_Result[] | null;
...
interface ovs_operation_Select {
  ...
  ts_aviationsecuritytraining: WebAttribute<ovs_operation_Select, { ts_aviationsecuritytraining: boolean | null }, {  }>;
  ts_canvasappnumber: WebAttribute<ovs_operation_Select, { ts_canvasappnumber: string | null }, {  }>;
  ts_cargo: WebAttribute<ovs_operation_Select, { ts_cargo: boolean | null }, {  }>;
  ts_cateringandstores: WebAttribute<ovs_operation_Select, { ts_cateringandstores: boolean | null }, {  }>;
  ...
  ts_domesticflights: WebAttribute<ovs_operation_Select, { ts_domesticflights: boolean | null }, {  }>;
  ts_frequency: WebAttribute<ovs_operation_Select, { ts_frequency: number | null }, {  }>;
  ts_internationalflights: WebAttribute<ovs_operation_Select, { ts_internationalflights: boolean | null }, {  }>;
  ts_internationalprogramsbranchipb: WebAttribute<ovs_operation_Select, { ts_internationalprogramsbranchipb: boolean | null }, {  }>;
  ...
  ts_unattendedaircraft: WebAttribute<ovs_operation_Select, { ts_unattendedaircraft: boolean | null }, {  }>;
...
interface ovs_operation_Expand {
  ...
  ts_File_ovs_operation_ovs_operation: WebExpand<ovs_operation_Expand, ts_File_Select, ts_File_Filter, { ts_File_ovs_operation_ovs_operation: ts_File_Result[] }>;
  ts_Files_ovs_operations: WebExpand<ovs_operation_Expand, ts_File_Select, ts_File_Filter, { ts_Files_ovs_operations: ts_File_Result[] }>;
  ...
  ts_operationriskassessment_operation: WebExpand<ovs_operation_Expand, ts_operationriskassessment_Select, ts_operationriskassessment_Filter, { ts_operationriskassessment_operation: ts_operationriskassessment_Result[] }>;
  ...
  ts_ovs_operation_ts_unplannedworkorder_ts_unplannedworkorder: WebExpand<ovs_operation_Expand, ts_unplannedworkorder_Select, ts_unplannedworkorder_Filter, { ts_ovs_operation_ts_unplannedworkorder_ts_unplannedworkorder: ts_unplannedworkorder_Result[] }>;
...
interface ovs_operation_RelatedMany {
  ...
  ts_File_ovs_operation_ovs_operation: WebMappingRetrieve<ts_File_Select,ts_File_Expand,ts_File_Filter,ts_File_Fixed,ts_File_Result,ts_File_FormattedResult>;
  ...
  ts_operationriskassessment_operation: WebMappingRetrieve<ts_operationriskassessment_Select,ts_operationriskassessment_Expand,ts_operationriskassessment_Filter,ts_operationriskassessment_Fixed,ts_operationriskassessment_Result,ts_operationriskassessment_FormattedResult>;
  ...
  ts_ovs_operation_ts_unplannedworkorder_ts_unplannedworkorder: WebMappingRetrieve<ts_unplannedworkorder_Select,ts_unplannedworkorder_Expand,ts_unplannedworkorder_Filter,ts_unplannedworkorder_Fixed,ts_unplannedworkorder_Result,ts_unplannedworkorder_FormattedResult>;
