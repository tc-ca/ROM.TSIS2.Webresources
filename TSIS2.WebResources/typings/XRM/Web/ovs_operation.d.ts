...
interface ovs_operation_Expand {
  ...
  ovs_LOBId: WebExpand<ovs_operation_Expand, ovs_lob_Select, ovs_lob_Filter, { ovs_LOBId: ovs_lob_Result }>;
...
interface ovs_operation_RelatedOne {
  ...
  ovs_LOBId: WebMappingRetrieve<ovs_lob_Select,ovs_lob_Expand,ovs_lob_Filter,ovs_lob_Fixed,ovs_lob_Result,ovs_lob_FormattedResult>;
