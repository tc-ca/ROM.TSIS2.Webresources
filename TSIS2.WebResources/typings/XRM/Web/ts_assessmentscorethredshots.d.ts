...
interface ts_assessmentscorethredshots_Expand {
  ...
  ownerid: WebExpand<ts_assessmentscorethredshots_Expand, SystemUser_Select & Team_Select, SystemUser_Filter & Team_Filter, { ownerid: SystemUser_Result } & { ownerid: Team_Result }>;
  owningbusinessunit: WebExpand<ts_assessmentscorethredshots_Expand, BusinessUnit_Select, BusinessUnit_Filter, { owningbusinessunit: BusinessUnit_Result }>;
  owningteam: WebExpand<ts_assessmentscorethredshots_Expand, Team_Select, Team_Filter, { owningteam: Team_Result }>;
