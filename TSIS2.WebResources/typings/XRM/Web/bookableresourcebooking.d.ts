...
interface BookableResourceBooking_Relationships {
  ...
  bookableresourcebooking_ovs_CYActions?: ovs_CYAction_Result[] | null;
  bookableresourcebooking_ovs_cancellationrequests?: ovs_cancellationrequest_Result[] | null;
  bookableresourcebooking_ovs_revisedquarterrequests?: ovs_revisedquarterrequest_Result[] | null;
...
interface BookableResourceBooking_Expand {
  ...
  bookableresourcebooking_ovs_CYActions: WebExpand<BookableResourceBooking_Expand, ovs_CYAction_Select, ovs_CYAction_Filter, { bookableresourcebooking_ovs_CYActions: ovs_CYAction_Result[] }>;
  bookableresourcebooking_ovs_cancellationrequests: WebExpand<BookableResourceBooking_Expand, ovs_cancellationrequest_Select, ovs_cancellationrequest_Filter, { bookableresourcebooking_ovs_cancellationrequests: ovs_cancellationrequest_Result[] }>;
  bookableresourcebooking_ovs_revisedquarterrequests: WebExpand<BookableResourceBooking_Expand, ovs_revisedquarterrequest_Select, ovs_revisedquarterrequest_Filter, { bookableresourcebooking_ovs_revisedquarterrequests: ovs_revisedquarterrequest_Result[] }>;
...
interface BookableResourceBooking_RelatedMany {
  ...
  bookableresourcebooking_ovs_CYActions: WebMappingRetrieve<ovs_CYAction_Select,ovs_CYAction_Expand,ovs_CYAction_Filter,ovs_CYAction_Fixed,ovs_CYAction_Result,ovs_CYAction_FormattedResult>;
  bookableresourcebooking_ovs_cancellationrequests: WebMappingRetrieve<ovs_cancellationrequest_Select,ovs_cancellationrequest_Expand,ovs_cancellationrequest_Filter,ovs_cancellationrequest_Fixed,ovs_cancellationrequest_Result,ovs_cancellationrequest_FormattedResult>;
  bookableresourcebooking_ovs_revisedquarterrequests: WebMappingRetrieve<ovs_revisedquarterrequest_Select,ovs_revisedquarterrequest_Expand,ovs_revisedquarterrequest_Filter,ovs_revisedquarterrequest_Fixed,ovs_revisedquarterrequest_Result,ovs_revisedquarterrequest_FormattedResult>;
