...
interface qm_sytemplate_Relationships {
  ...
  qm_qm_sytemplate_qm_syquestion_templateid?: qm_syquestion_Result[] | null;
...
interface qm_sytemplate_Expand {
  ...
  qm_qm_sytemplate_qm_syquestion_templateid: WebExpand<qm_sytemplate_Expand, qm_syquestion_Select, qm_syquestion_Filter, { qm_qm_sytemplate_qm_syquestion_templateid: qm_syquestion_Result[] }>;
  qm_sytemplate_sygroup: WebExpand<qm_sytemplate_Expand, qm_sygroup_Select, qm_sygroup_Filter, { qm_sytemplate_sygroup: qm_sygroup_Result[] }>;
}
...
interface qm_sytemplate_RelatedMany {
  ...
  qm_qm_sytemplate_qm_syquestion_templateid: WebMappingRetrieve<qm_syquestion_Select,qm_syquestion_Expand,qm_syquestion_Filter,qm_syquestion_Fixed,qm_syquestion_Result,qm_syquestion_FormattedResult>;
