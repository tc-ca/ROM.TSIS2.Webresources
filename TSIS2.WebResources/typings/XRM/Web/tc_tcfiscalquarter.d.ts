...
interface tc_TCFiscalQuarter_Relationships {
  ...
  ts_unplannedworkorder_PlannedFiscalQuarter_tc_tcfiscalquarter?: ts_unplannedworkorder_Result[] | null;
  ts_unplannedworkorder_revisedquarterid_tc_tcfiscalquarter?: ts_unplannedworkorder_Result[] | null;
}
...
interface tc_TCFiscalQuarter_Expand {
  ...
  ts_unplannedworkorder_PlannedFiscalQuarter_tc_tcfiscalquarter: WebExpand<tc_TCFiscalQuarter_Expand, ts_unplannedworkorder_Select, ts_unplannedworkorder_Filter, { ts_unplannedworkorder_PlannedFiscalQuarter_tc_tcfiscalquarter: ts_unplannedworkorder_Result[] }>;
  ts_unplannedworkorder_revisedquarterid_tc_tcfiscalquarter: WebExpand<tc_TCFiscalQuarter_Expand, ts_unplannedworkorder_Select, ts_unplannedworkorder_Filter, { ts_unplannedworkorder_revisedquarterid_tc_tcfiscalquarter: ts_unplannedworkorder_Result[] }>;
}
...
interface tc_TCFiscalQuarter_RelatedMany {
  ...
  ts_unplannedworkorder_PlannedFiscalQuarter_tc_tcfiscalquarter: WebMappingRetrieve<ts_unplannedworkorder_Select,ts_unplannedworkorder_Expand,ts_unplannedworkorder_Filter,ts_unplannedworkorder_Fixed,ts_unplannedworkorder_Result,ts_unplannedworkorder_FormattedResult>;
  ts_unplannedworkorder_revisedquarterid_tc_tcfiscalquarter: WebMappingRetrieve<ts_unplannedworkorder_Select,ts_unplannedworkorder_Expand,ts_unplannedworkorder_Filter,ts_unplannedworkorder_Fixed,ts_unplannedworkorder_Result,ts_unplannedworkorder_FormattedResult>;
}
