...
interface ts_ActionFinding_Expand {
  ...
  owningbusinessunit: WebExpand<ts_ActionFinding_Expand, BusinessUnit_Select, BusinessUnit_Filter, { owningbusinessunit: BusinessUnit_Result }>;
  ...
  ts_action: WebExpand<ts_ActionFinding_Expand, ts_action_Select, ts_action_Filter, { ts_action: ts_action_Result }>;
