...
interface ts_UserRegistration_Relationships {
  ts_BusinessUnit?: BusinessUnit_Result | null;
}
...
interface ts_UserRegistration_Expand {
  ...
  owningbusinessunit: WebExpand<ts_UserRegistration_Expand, BusinessUnit_Select, BusinessUnit_Filter, { owningbusinessunit: BusinessUnit_Result }>;
  ...
  ts_BusinessUnit: WebExpand<ts_UserRegistration_Expand, BusinessUnit_Select, BusinessUnit_Filter, { ts_BusinessUnit: BusinessUnit_Result }>;
}
...
interface ts_UserRegistration_RelatedOne {
  ...
  ts_BusinessUnit: WebMappingRetrieve<BusinessUnit_Select,BusinessUnit_Expand,BusinessUnit_Filter,BusinessUnit_Fixed,BusinessUnit_Result,BusinessUnit_FormattedResult>;
}
