...
interface Contact_Relationships {
  ...
  contact_ovs_CYActions?: ovs_CYAction_Result[] | null;
  contact_ovs_cancellationrequests?: ovs_cancellationrequest_Result[] | null;
  contact_ovs_revisedquarterrequests?: ovs_revisedquarterrequest_Result[] | null;
...
interface Contact_Expand {
  ...
  contact_ovs_CYActions: WebExpand<Contact_Expand, ovs_CYAction_Select, ovs_CYAction_Filter, { contact_ovs_CYActions: ovs_CYAction_Result[] }>;
  contact_ovs_cancellationrequests: WebExpand<Contact_Expand, ovs_cancellationrequest_Select, ovs_cancellationrequest_Filter, { contact_ovs_cancellationrequests: ovs_cancellationrequest_Result[] }>;
  contact_ovs_revisedquarterrequests: WebExpand<Contact_Expand, ovs_revisedquarterrequest_Select, ovs_revisedquarterrequest_Filter, { contact_ovs_revisedquarterrequests: ovs_revisedquarterrequest_Result[] }>;
...
interface Contact_RelatedMany {
  ...
  contact_ovs_CYActions: WebMappingRetrieve<ovs_CYAction_Select,ovs_CYAction_Expand,ovs_CYAction_Filter,ovs_CYAction_Fixed,ovs_CYAction_Result,ovs_CYAction_FormattedResult>;
  contact_ovs_cancellationrequests: WebMappingRetrieve<ovs_cancellationrequest_Select,ovs_cancellationrequest_Expand,ovs_cancellationrequest_Filter,ovs_cancellationrequest_Fixed,ovs_cancellationrequest_Result,ovs_cancellationrequest_FormattedResult>;
  contact_ovs_revisedquarterrequests: WebMappingRetrieve<ovs_revisedquarterrequest_Select,ovs_revisedquarterrequest_Expand,ovs_revisedquarterrequest_Filter,ovs_revisedquarterrequest_Fixed,ovs_revisedquarterrequest_Result,ovs_revisedquarterrequest_FormattedResult>;
