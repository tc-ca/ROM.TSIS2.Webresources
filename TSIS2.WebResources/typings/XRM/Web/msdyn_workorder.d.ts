...
interface msdyn_workorder_Relationships {
  ...
  ts_msdyn_workorder_Team_Team?: Team_Result[] | null;
  ...
  ts_unplannedworkorder_ParentWorkOrder_msdyn_workorder?: ts_unplannedworkorder_Result[] | null;
...
interface msdyn_workorder extends msdyn_workorder_Base, msdyn_workorder_Relationships {
  ...
  ts_ServiceTerritoryNew_bind$ts_regions?: string | null;
...
interface msdyn_workorder_Select {
  ...
  ts_arrivalaerodrome_site_guid: WebAttribute<msdyn_workorder_Select, { ts_arrivalaerodrome_site_guid: string | null }, { ts_arrivalaerodrome_site_formatted?: string }>;
  ts_businessowner: WebAttribute<msdyn_workorder_Select, { ts_businessowner: string | null }, {  }>;
  ...
  ts_regiondonotuse_guid: WebAttribute<msdyn_workorder_Select, { ts_regiondonotuse_guid: string | null }, { ts_regiondonotuse_formatted?: string }>;
...
interface msdyn_workorder_Expand {
  ...
  ts_ArrivalAerodrome_Site: WebExpand<msdyn_workorder_Expand, ts_site_Select, ts_site_Filter, { ts_ArrivalAerodrome_Site: ts_site_Result }>;
  ...
  ts_Site_Site: WebExpand<msdyn_workorder_Expand, ts_site_Select, ts_site_Filter, { ts_Site_Site: ts_site_Result }>;
  ...
  ts_Subsubsite_Site: WebExpand<msdyn_workorder_Expand, ts_site_Select, ts_site_Filter, { ts_Subsubsite_Site: ts_site_Result }>;
  ...
  ts_msdyn_workorder_Team_Team: WebExpand<msdyn_workorder_Expand, Team_Select, Team_Filter, { ts_msdyn_workorder_Team_Team: Team_Result[] }>;
  ...
  ts_questionnaireresponse_WorkOrder_msdyn_workorder: WebExpand<msdyn_workorder_Expand, ts_questionnaireresponse_Select, ts_questionnaireresponse_Filter, { ts_questionnaireresponse_WorkOrder_msdyn_workorder: ts_questionnaireresponse_Result[] }>;
  ...
  ts_unplannedworkorder_ParentWorkOrder_msdyn_workorder: WebExpand<msdyn_workorder_Expand, ts_unplannedworkorder_Select, ts_unplannedworkorder_Filter, { ts_unplannedworkorder_ParentWorkOrder_msdyn_workorder: ts_unplannedworkorder_Result[] }>;
...
interface msdyn_workorder_FormattedResult {
  ...
  ts_serviceterritorynew_formatted?: string;
...
interface msdyn_workorder_Result extends msdyn_workorder_Base, msdyn_workorder_Relationships {
  ...
  ts_serviceterritorynew_guid: string | null;
...
interface msdyn_workorder_RelatedMany {
  ...
  ts_msdyn_workorder_Team_Team: WebMappingRetrieve<Team_Select,Team_Expand,Team_Filter,Team_Fixed,Team_Result,Team_FormattedResult>;
  ...
  ts_unplannedworkorder_ParentWorkOrder_msdyn_workorder: WebMappingRetrieve<ts_unplannedworkorder_Select,ts_unplannedworkorder_Expand,ts_unplannedworkorder_Filter,ts_unplannedworkorder_Fixed,ts_unplannedworkorder_Result,ts_unplannedworkorder_FormattedResult>;
