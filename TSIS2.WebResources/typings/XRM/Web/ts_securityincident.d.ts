...
interface ts_securityincident_Relationships {
  ...
  ts_ts_securityincident_ts_file_SecurityIncident?: ts_File_Result[] | null;
  ts_unplannedworkorder_SecurityIncident_ts_securityincident?: ts_unplannedworkorder_Result[] | null;
}
interface ts_securityincident extends ts_securityincident_Base, ts_securityincident_Relationships {
  ...
  ts_Destination_Site_bind$ts_sites?: string | null;
  ...
  ts_Subcategory_bind$ts_securityincidentsubcategories?: string | null;
...
interface ts_securityincident_Select {
  ...
  ts_destination_site_guid: WebAttribute<ts_securityincident_Select, { ts_destination_site_guid: string | null }, { ts_destination_site_formatted?: string }>;
  ...
  ts_origin_site_guid: WebAttribute<ts_securityincident_Select, { ts_origin_site_guid: string | null }, { ts_origin_site_formatted?: string }>;
  ...
  ts_regionnew_guid: WebAttribute<ts_securityincident_Select, { ts_regionnew_guid: string | null }, { ts_regionnew_formatted?: string }>;
  ...
  ts_site_site_guid: WebAttribute<ts_securityincident_Select, { ts_site_site_guid: string | null }, { ts_site_site_formatted?: string }>;
  ...
  ts_subcategory_guid: WebAttribute<ts_securityincident_Select, { ts_subcategory_guid: string | null }, { ts_subcategory_formatted?: string }>;
  ...
  ts_subsite_site_guid: WebAttribute<ts_securityincident_Select, { ts_subsite_site_guid: string | null }, { ts_subsite_site_formatted?: string }>;
...
interface ts_securityincident_Filter {
  ...
  ts_destination_site_guid: XQW.Guid;
  ts_details: string;
...
interface ts_securityincident_Expand {
  ...
  ts_ts_securityincident_ts_file_SecurityIncident: WebExpand<ts_securityincident_Expand, ts_File_Select, ts_File_Filter, { ts_ts_securityincident_ts_file_SecurityIncident: ts_File_Result[] }>;
  ts_unplannedworkorder_SecurityIncident_ts_securityincident: WebExpand<ts_securityincident_Expand, ts_unplannedworkorder_Select, ts_unplannedworkorder_Filter, { ts_unplannedworkorder_SecurityIncident_ts_securityincident: ts_unplannedworkorder_Result[] }>;
}
interface ts_securityincident_FormattedResult {
  ...
  ts_origin_site_formatted?: string;
  ...
  ts_subcategory_formatted?: string;
...
interface ts_securityincident_Result extends ts_securityincident_Base, ts_securityincident_Relationships {
  ...
  ts_subcategory_guid: string | null;
...
interface ts_securityincident_RelatedMany {
  ...
  ts_ts_securityincident_ts_file_SecurityIncident: WebMappingRetrieve<ts_File_Select,ts_File_Expand,ts_File_Filter,ts_File_Fixed,ts_File_Result,ts_File_FormattedResult>;
  ts_unplannedworkorder_SecurityIncident_ts_securityincident: WebMappingRetrieve<ts_unplannedworkorder_Select,ts_unplannedworkorder_Expand,ts_unplannedworkorder_Filter,ts_unplannedworkorder_Fixed,ts_unplannedworkorder_Result,ts_unplannedworkorder_FormattedResult>;
}
