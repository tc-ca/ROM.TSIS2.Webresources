interface Appointment_Base extends WebEntity {
  ...
  msdyn_ci_call_summary_control_field?: number | null;
  msdyn_ci_id?: string | null;
  msdyn_ci_insights_json?: string | null;
  msdyn_ci_keywords?: string | null;
  msdyn_ci_media_reference_id?: string | null;
  msdyn_ci_transcript?: string | null;
  msdyn_ci_transcript_json?: string | null;
  msdyn_ci_translated_transcript?: string | null;
  msdyn_ci_translated_transcript_json?: string | null;
  msdyn_ci_url?: string | null;
...
interface Appointment_Select {
  ...
  msdyn_ci_call_summary_control_field: WebAttribute<Appointment_Select, { msdyn_ci_call_summary_control_field: number | null }, {  }>;
  msdyn_ci_id: WebAttribute<Appointment_Select, { msdyn_ci_id: string | null }, {  }>;
  msdyn_ci_insights_json: WebAttribute<Appointment_Select, { msdyn_ci_insights_json: string | null }, {  }>;
  msdyn_ci_keywords: WebAttribute<Appointment_Select, { msdyn_ci_keywords: string | null }, {  }>;
  msdyn_ci_media_reference_id: WebAttribute<Appointment_Select, { msdyn_ci_media_reference_id: string | null }, {  }>;
  msdyn_ci_transcript: WebAttribute<Appointment_Select, { msdyn_ci_transcript: string | null }, {  }>;
  msdyn_ci_transcript_json: WebAttribute<Appointment_Select, { msdyn_ci_transcript_json: string | null }, {  }>;
  msdyn_ci_translated_transcript: WebAttribute<Appointment_Select, { msdyn_ci_translated_transcript: string | null }, {  }>;
  msdyn_ci_translated_transcript_json: WebAttribute<Appointment_Select, { msdyn_ci_translated_transcript_json: string | null }, {  }>;
  msdyn_ci_url: WebAttribute<Appointment_Select, { msdyn_ci_url: string | null }, {  }>;
...
interface Appointment_Filter {
  ...
  msdyn_ci_call_summary_control_field: number;
  msdyn_ci_id: string;
  msdyn_ci_insights_json: string;
  msdyn_ci_keywords: string;
  msdyn_ci_media_reference_id: string;
