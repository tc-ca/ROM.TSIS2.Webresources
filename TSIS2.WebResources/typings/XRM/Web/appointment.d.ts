...
interface Appointment_Relationships {
  ...
  regardingobjectid_ts_case_appointment?: ts_case_Result | null;
...
interface Appointment extends Appointment_Base, Appointment_Relationships {
  ...
  regardingobjectid_ts_case_appointment_bind$ts_cases?: string | null;
  ...
  regardingobjectid_ts_unplannedworkorder_appointment_bind$ts_unplannedworkorders?: string | null;
...
interface Appointment_Expand {
  ...
  regardingobjectid_ts_case_appointment: WebExpand<Appointment_Expand, ts_case_Select, ts_case_Filter, { regardingobjectid_ts_case_appointment: ts_case_Result }>;
...
interface Appointment_RelatedOne {
  ...
  regardingobjectid_ts_case_appointment: WebMappingRetrieve<ts_case_Select,ts_case_Expand,ts_case_Filter,ts_case_Fixed,ts_case_Result,ts_case_FormattedResult>;
