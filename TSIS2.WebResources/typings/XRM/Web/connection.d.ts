...
interface Connection_Relationships {
  ...
  record1id_ovs_cancellationrequest?: ovs_cancellationrequest_Result | null;
  record1id_ovs_cyaction?: ovs_CYAction_Result | null;
  record1id_ovs_revisedquarterrequest?: ovs_revisedquarterrequest_Result | null;
  ...
  record2id_ovs_cancellationrequest?: ovs_cancellationrequest_Result | null;
  record2id_ovs_cyaction?: ovs_CYAction_Result | null;
  record2id_ovs_revisedquarterrequest?: ovs_revisedquarterrequest_Result | null;
...
interface Connection_Expand {
  ...
  record1id_ovs_cancellationrequest: WebExpand<Connection_Expand, ovs_cancellationrequest_Select, ovs_cancellationrequest_Filter, { record1id_ovs_cancellationrequest: ovs_cancellationrequest_Result }>;
  record1id_ovs_cyaction: WebExpand<Connection_Expand, ovs_CYAction_Select, ovs_CYAction_Filter, { record1id_ovs_cyaction: ovs_CYAction_Result }>;
  record1id_ovs_revisedquarterrequest: WebExpand<Connection_Expand, ovs_revisedquarterrequest_Select, ovs_revisedquarterrequest_Filter, { record1id_ovs_revisedquarterrequest: ovs_revisedquarterrequest_Result }>;
  ...
  record2id_ovs_cancellationrequest: WebExpand<Connection_Expand, ovs_cancellationrequest_Select, ovs_cancellationrequest_Filter, { record2id_ovs_cancellationrequest: ovs_cancellationrequest_Result }>;
  record2id_ovs_cyaction: WebExpand<Connection_Expand, ovs_CYAction_Select, ovs_CYAction_Filter, { record2id_ovs_cyaction: ovs_CYAction_Result }>;
  record2id_ovs_revisedquarterrequest: WebExpand<Connection_Expand, ovs_revisedquarterrequest_Select, ovs_revisedquarterrequest_Filter, { record2id_ovs_revisedquarterrequest: ovs_revisedquarterrequest_Result }>;
...
interface Connection_RelatedOne {
  ...
  record1id_ovs_cancellationrequest: WebMappingRetrieve<ovs_cancellationrequest_Select,ovs_cancellationrequest_Expand,ovs_cancellationrequest_Filter,ovs_cancellationrequest_Fixed,ovs_cancellationrequest_Result,ovs_cancellationrequest_FormattedResult>;
  record1id_ovs_cyaction: WebMappingRetrieve<ovs_CYAction_Select,ovs_CYAction_Expand,ovs_CYAction_Filter,ovs_CYAction_Fixed,ovs_CYAction_Result,ovs_CYAction_FormattedResult>;
  record1id_ovs_revisedquarterrequest: WebMappingRetrieve<ovs_revisedquarterrequest_Select,ovs_revisedquarterrequest_Expand,ovs_revisedquarterrequest_Filter,ovs_revisedquarterrequest_Fixed,ovs_revisedquarterrequest_Result,ovs_revisedquarterrequest_FormattedResult>;
  ...
  record2id_ovs_cancellationrequest: WebMappingRetrieve<ovs_cancellationrequest_Select,ovs_cancellationrequest_Expand,ovs_cancellationrequest_Filter,ovs_cancellationrequest_Fixed,ovs_cancellationrequest_Result,ovs_cancellationrequest_FormattedResult>;
  record2id_ovs_cyaction: WebMappingRetrieve<ovs_CYAction_Select,ovs_CYAction_Expand,ovs_CYAction_Filter,ovs_CYAction_Fixed,ovs_CYAction_Result,ovs_CYAction_FormattedResult>;
  record2id_ovs_revisedquarterrequest: WebMappingRetrieve<ovs_revisedquarterrequest_Select,ovs_revisedquarterrequest_Expand,ovs_revisedquarterrequest_Filter,ovs_revisedquarterrequest_Fixed,ovs_revisedquarterrequest_Result,ovs_revisedquarterrequest_FormattedResult>;
