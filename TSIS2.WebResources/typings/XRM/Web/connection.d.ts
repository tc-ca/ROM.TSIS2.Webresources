...
interface Connection_Relationships {
  ...
  record1id_msdyn_incidenttype?: msdyn_incidenttype_Result | null;
  ...
  record1id_ovs_finding?: ovs_Finding_Result | null;
  record1id_ovs_operation?: ovs_operation_Result | null;
  record1id_qm_rclegislation?: qm_rclegislation_Result | null;
  ...
  record2id_msdyn_incidenttype?: msdyn_incidenttype_Result | null;
  ...
  record2id_ovs_finding?: ovs_Finding_Result | null;
  record2id_ovs_operation?: ovs_operation_Result | null;
  record2id_qm_rclegislation?: qm_rclegislation_Result | null;
...
interface Connection extends Connection_Base, Connection_Relationships {
  ...
  record1id_ikl_a2d_securitytemplate_bind$ikl_a2d_securitytemplates?: string | null;
  record1id_ikl_bulkmigrationjob_bind$ikl_bulkmigrationjobs?: string | null;
  record1id_ikl_bulkmigrationjobstatus_bind$ikl_bulkmigrationjobstatuses?: string | null;
  record1id_ikl_connector_bind$ikl_connectors?: string | null;
  record1id_ikl_entityconfiguration_bind$ikl_entityconfigurations?: string | null;
  record1id_ikl_inogiclicensedetails_bind$ikl_inogiclicensedetailses?: string | null;
  ...
  record1id_msdyn_incidenttype_bind$msdyn_incidenttypes?: string | null;
  ...
  record1id_ovs_finding_bind$ovs_findings?: string | null;
  ...
  record1id_qm_rclegislation_bind$qm_rclegislations?: string | null;
  ...
  record1id_tc_country_bind$tc_countries?: string | null;
  ...
  record2id_ikl_a2d_securitytemplate_bind$ikl_a2d_securitytemplates?: string | null;
  record2id_ikl_bulkmigrationjob_bind$ikl_bulkmigrationjobs?: string | null;
  record2id_ikl_bulkmigrationjobstatus_bind$ikl_bulkmigrationjobstatuses?: string | null;
  record2id_ikl_connector_bind$ikl_connectors?: string | null;
  record2id_ikl_entityconfiguration_bind$ikl_entityconfigurations?: string | null;
  record2id_ikl_inogiclicensedetails_bind$ikl_inogiclicensedetailses?: string | null;
  ...
  record2id_msdyn_incidenttype_bind$msdyn_incidenttypes?: string | null;
  ...
  record2id_ovs_finding_bind$ovs_findings?: string | null;
  ...
  record2id_qm_rclegislation_bind$qm_rclegislations?: string | null;
  ...
  record2id_tc_country_bind$tc_countries?: string | null;
...
interface Connection_Expand {
  ...
  record1id_msdyn_incidenttype: WebExpand<Connection_Expand, msdyn_incidenttype_Select, msdyn_incidenttype_Filter, { record1id_msdyn_incidenttype: msdyn_incidenttype_Result }>;
  ...
  record1id_ovs_finding: WebExpand<Connection_Expand, ovs_Finding_Select, ovs_Finding_Filter, { record1id_ovs_finding: ovs_Finding_Result }>;
  ...
  record1id_qm_rclegislation: WebExpand<Connection_Expand, qm_rclegislation_Select, qm_rclegislation_Filter, { record1id_qm_rclegislation: qm_rclegislation_Result }>;
  ...
  record2id_msdyn_incidenttype: WebExpand<Connection_Expand, msdyn_incidenttype_Select, msdyn_incidenttype_Filter, { record2id_msdyn_incidenttype: msdyn_incidenttype_Result }>;
  ...
  record2id_ovs_finding: WebExpand<Connection_Expand, ovs_Finding_Select, ovs_Finding_Filter, { record2id_ovs_finding: ovs_Finding_Result }>;
  ...
  record2id_qm_rclegislation: WebExpand<Connection_Expand, qm_rclegislation_Select, qm_rclegislation_Filter, { record2id_qm_rclegislation: qm_rclegislation_Result }>;
...
interface Connection_RelatedOne {
  ...
  record1id_msdyn_incidenttype: WebMappingRetrieve<msdyn_incidenttype_Select,msdyn_incidenttype_Expand,msdyn_incidenttype_Filter,msdyn_incidenttype_Fixed,msdyn_incidenttype_Result,msdyn_incidenttype_FormattedResult>;
  ...
  record1id_ovs_finding: WebMappingRetrieve<ovs_Finding_Select,ovs_Finding_Expand,ovs_Finding_Filter,ovs_Finding_Fixed,ovs_Finding_Result,ovs_Finding_FormattedResult>;
  ...
  record1id_qm_rclegislation: WebMappingRetrieve<qm_rclegislation_Select,qm_rclegislation_Expand,qm_rclegislation_Filter,qm_rclegislation_Fixed,qm_rclegislation_Result,qm_rclegislation_FormattedResult>;
  ...
  record2id_msdyn_incidenttype: WebMappingRetrieve<msdyn_incidenttype_Select,msdyn_incidenttype_Expand,msdyn_incidenttype_Filter,msdyn_incidenttype_Fixed,msdyn_incidenttype_Result,msdyn_incidenttype_FormattedResult>;
  ...
  record2id_ovs_finding: WebMappingRetrieve<ovs_Finding_Select,ovs_Finding_Expand,ovs_Finding_Filter,ovs_Finding_Fixed,ovs_Finding_Result,ovs_Finding_FormattedResult>;
  ...
  record2id_qm_rclegislation: WebMappingRetrieve<qm_rclegislation_Select,qm_rclegislation_Expand,qm_rclegislation_Filter,qm_rclegislation_Fixed,qm_rclegislation_Result,qm_rclegislation_FormattedResult>;
