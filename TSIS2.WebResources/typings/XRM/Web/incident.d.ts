...
interface Incident_Relationships {
  ...
  incident_ovs_CYActions?: ovs_CYAction_Result[] | null;
  incident_ovs_cancellationrequests?: ovs_cancellationrequest_Result[] | null;
  incident_ovs_revisedquarterrequests?: ovs_revisedquarterrequest_Result[] | null;
...
interface Incident_Expand {
  ...
  incident_ovs_CYActions: WebExpand<Incident_Expand, ovs_CYAction_Select, ovs_CYAction_Filter, { incident_ovs_CYActions: ovs_CYAction_Result[] }>;
  incident_ovs_cancellationrequests: WebExpand<Incident_Expand, ovs_cancellationrequest_Select, ovs_cancellationrequest_Filter, { incident_ovs_cancellationrequests: ovs_cancellationrequest_Result[] }>;
  incident_ovs_revisedquarterrequests: WebExpand<Incident_Expand, ovs_revisedquarterrequest_Select, ovs_revisedquarterrequest_Filter, { incident_ovs_revisedquarterrequests: ovs_revisedquarterrequest_Result[] }>;
...
interface Incident_RelatedMany {
  ...
  incident_ovs_CYActions: WebMappingRetrieve<ovs_CYAction_Select,ovs_CYAction_Expand,ovs_CYAction_Filter,ovs_CYAction_Fixed,ovs_CYAction_Result,ovs_CYAction_FormattedResult>;
  incident_ovs_cancellationrequests: WebMappingRetrieve<ovs_cancellationrequest_Select,ovs_cancellationrequest_Expand,ovs_cancellationrequest_Filter,ovs_cancellationrequest_Fixed,ovs_cancellationrequest_Result,ovs_cancellationrequest_FormattedResult>;
  incident_ovs_revisedquarterrequests: WebMappingRetrieve<ovs_revisedquarterrequest_Select,ovs_revisedquarterrequest_Expand,ovs_revisedquarterrequest_Filter,ovs_revisedquarterrequest_Fixed,ovs_revisedquarterrequest_Result,ovs_revisedquarterrequest_FormattedResult>;
