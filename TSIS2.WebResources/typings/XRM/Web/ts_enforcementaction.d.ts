interface ts_EnforcementAction_Base extends WebEntity {
  ...
  ts_verbalwarningwhere?: ts_verbalwarningwhere | null;
  ts_verbalwarningwheredetails?: string | null;
...
interface ts_EnforcementAction_Relationships {
  ...
  ts_IndividualCompany?: Account_Result | null;
...
interface ts_EnforcementAction extends ts_EnforcementAction_Base, ts_EnforcementAction_Relationships {
  ...
  ts_IndividualCompany_bind$accounts?: string | null;
...
interface ts_EnforcementAction_Select {
  ...
  ts_verbalwarningwhere: WebAttribute<ts_EnforcementAction_Select, { ts_verbalwarningwhere: ts_verbalwarningwhere | null }, { ts_verbalwarningwhere_formatted?: string }>;
  ts_verbalwarningwheredetails: WebAttribute<ts_EnforcementAction_Select, { ts_verbalwarningwheredetails: string | null }, {  }>;
...
interface ts_EnforcementAction_Filter {
  ...
  ts_verbalwarningwhere: ts_verbalwarningwhere;
  ts_verbalwarningwheredetails: string;
...
interface ts_EnforcementAction_Expand {
  ...
  ts_IndividualCompany: WebExpand<ts_EnforcementAction_Expand, Account_Select, Account_Filter, { ts_IndividualCompany: Account_Result }>;
...
interface ts_EnforcementAction_RelatedOne {
  ...
  ts_IndividualCompany: WebMappingRetrieve<Account_Select,Account_Expand,Account_Filter,Account_Fixed,Account_Result,Account_FormattedResult>;
