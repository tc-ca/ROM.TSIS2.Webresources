...
interface ActivityParty_Relationships {
  ...
  activityid_ovs_cancellationrequest_activityparty?: ovs_cancellationrequest_Result | null;
  activityid_ovs_cyaction_activityparty?: ovs_CYAction_Result | null;
  activityid_ovs_revisedquarterrequest_activityparty?: ovs_revisedquarterrequest_Result | null;
...
interface ActivityParty_Expand {
  ...
  activityid_ovs_cancellationrequest_activityparty: WebExpand<ActivityParty_Expand, ovs_cancellationrequest_Select, ovs_cancellationrequest_Filter, { activityid_ovs_cancellationrequest_activityparty: ovs_cancellationrequest_Result }>;
  activityid_ovs_cyaction_activityparty: WebExpand<ActivityParty_Expand, ovs_CYAction_Select, ovs_CYAction_Filter, { activityid_ovs_cyaction_activityparty: ovs_CYAction_Result }>;
  activityid_ovs_revisedquarterrequest_activityparty: WebExpand<ActivityParty_Expand, ovs_revisedquarterrequest_Select, ovs_revisedquarterrequest_Filter, { activityid_ovs_revisedquarterrequest_activityparty: ovs_revisedquarterrequest_Result }>;
...
interface ActivityParty_RelatedOne {
  ...
  activityid_ovs_cancellationrequest_activityparty: WebMappingRetrieve<ovs_cancellationrequest_Select,ovs_cancellationrequest_Expand,ovs_cancellationrequest_Filter,ovs_cancellationrequest_Fixed,ovs_cancellationrequest_Result,ovs_cancellationrequest_FormattedResult>;
  activityid_ovs_cyaction_activityparty: WebMappingRetrieve<ovs_CYAction_Select,ovs_CYAction_Expand,ovs_CYAction_Filter,ovs_CYAction_Fixed,ovs_CYAction_Result,ovs_CYAction_FormattedResult>;
  activityid_ovs_revisedquarterrequest_activityparty: WebMappingRetrieve<ovs_revisedquarterrequest_Select,ovs_revisedquarterrequest_Expand,ovs_revisedquarterrequest_Filter,ovs_revisedquarterrequest_Fixed,ovs_revisedquarterrequest_Result,ovs_revisedquarterrequest_FormattedResult>;
