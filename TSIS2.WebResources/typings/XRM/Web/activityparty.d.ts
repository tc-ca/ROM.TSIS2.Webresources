...
interface ActivityParty_Relationships {
  ...
  activityid_ts_enforcementaction_activityparty?: ts_enforcementaction_Result | null;
...
interface ActivityParty extends ActivityParty_Base, ActivityParty_Relationships {
  ...
  activityid_ts_incidentnotification_activityparty_bind$ts_incidentnotifications?: string | null;
  activityid_ts_incidentupdate_activityparty_bind$ts_incidentupdates?: string | null;
...
interface ActivityParty_Expand {
  ...
  activityid_ts_enforcementaction_activityparty: WebExpand<ActivityParty_Expand, ts_enforcementaction_Select, ts_enforcementaction_Filter, { activityid_ts_enforcementaction_activityparty: ts_enforcementaction_Result }>;
...
interface ActivityParty_RelatedOne {
  ...
  activityid_ts_enforcementaction_activityparty: WebMappingRetrieve<ts_enforcementaction_Select,ts_enforcementaction_Expand,ts_enforcementaction_Filter,ts_enforcementaction_Fixed,ts_enforcementaction_Result,ts_enforcementaction_FormattedResult>;
