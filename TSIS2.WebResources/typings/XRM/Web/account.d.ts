...
interface Account_Relationships {
  ...
  account_ovs_CYActions?: ovs_CYAction_Result[] | null;
  account_ovs_cancellationrequests?: ovs_cancellationrequest_Result[] | null;
  account_ovs_revisedquarterrequests?: ovs_revisedquarterrequest_Result[] | null;
  ...
  ovs_SiteType?: ovs_SiteType_Result | null;
...
interface Account_Expand {
  ...
  account_ovs_CYActions: WebExpand<Account_Expand, ovs_CYAction_Select, ovs_CYAction_Filter, { account_ovs_CYActions: ovs_CYAction_Result[] }>;
  account_ovs_cancellationrequests: WebExpand<Account_Expand, ovs_cancellationrequest_Select, ovs_cancellationrequest_Filter, { account_ovs_cancellationrequests: ovs_cancellationrequest_Result[] }>;
  account_ovs_revisedquarterrequests: WebExpand<Account_Expand, ovs_revisedquarterrequest_Select, ovs_revisedquarterrequest_Filter, { account_ovs_revisedquarterrequests: ovs_revisedquarterrequest_Result[] }>;
  ...
  msdyn_serviceterritory: WebExpand<Account_Expand, Territory_Select, Territory_Filter, { msdyn_serviceterritory: Territory_Result }>;
  ovs_SiteType: WebExpand<Account_Expand, ovs_SiteType_Select, ovs_SiteType_Filter, { ovs_SiteType: ovs_SiteType_Result }>;
  ...
  qm_account_tylegislationcharacteristic: WebExpand<Account_Expand, qm_tylegislationcharacteristic_Select, qm_tylegislationcharacteristic_Filter, { qm_account_tylegislationcharacteristic: qm_tylegislationcharacteristic_Result[] }>;
...
interface Account_RelatedOne {
  ...
  ovs_SiteType: WebMappingRetrieve<ovs_SiteType_Select,ovs_SiteType_Expand,ovs_SiteType_Filter,ovs_SiteType_Fixed,ovs_SiteType_Result,ovs_SiteType_FormattedResult>;
...
interface Account_RelatedMany {
  ...
  account_ovs_CYActions: WebMappingRetrieve<ovs_CYAction_Select,ovs_CYAction_Expand,ovs_CYAction_Filter,ovs_CYAction_Fixed,ovs_CYAction_Result,ovs_CYAction_FormattedResult>;
  account_ovs_cancellationrequests: WebMappingRetrieve<ovs_cancellationrequest_Select,ovs_cancellationrequest_Expand,ovs_cancellationrequest_Filter,ovs_cancellationrequest_Fixed,ovs_cancellationrequest_Result,ovs_cancellationrequest_FormattedResult>;
  account_ovs_revisedquarterrequests: WebMappingRetrieve<ovs_revisedquarterrequest_Select,ovs_revisedquarterrequest_Expand,ovs_revisedquarterrequest_Filter,ovs_revisedquarterrequest_Fixed,ovs_revisedquarterrequest_Result,ovs_revisedquarterrequest_FormattedResult>;
