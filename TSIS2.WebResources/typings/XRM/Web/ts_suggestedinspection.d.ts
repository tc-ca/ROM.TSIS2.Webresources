...
interface ts_SuggestedInspection_Expand {
  ...
  owningbusinessunit: WebExpand<ts_SuggestedInspection_Expand, BusinessUnit_Select, BusinessUnit_Filter, { owningbusinessunit: BusinessUnit_Result }>;
  ...
  ts_operationtype: WebExpand<ts_SuggestedInspection_Expand, ovs_operationtype_Select, ovs_operationtype_Filter, { ts_operationtype: ovs_operationtype_Result }>;
