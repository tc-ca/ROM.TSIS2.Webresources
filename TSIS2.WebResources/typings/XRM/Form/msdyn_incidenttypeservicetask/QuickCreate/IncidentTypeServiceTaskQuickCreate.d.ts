declare namespace Form.msdyn_incidenttypeservicetask.QuickCreate {
  namespace IncidentTypeServiceTaskQuickCreate {
    namespace Tabs {
  ...
  interface IncidentTypeServiceTaskQuickCreate extends Xrm.PageBase<IncidentTypeServiceTaskQuickCreate.Attributes,IncidentTypeServiceTaskQuickCreate.Tabs,IncidentTypeServiceTaskQuickCreate.Controls> {
