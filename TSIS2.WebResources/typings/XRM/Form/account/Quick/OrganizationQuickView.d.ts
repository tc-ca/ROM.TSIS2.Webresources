declare namespace Form.account.Quick {
  namespace OrganizationQuickView {
    namespace Tabs {
  ...
  interface OrganizationQuickView extends Xrm.PageBase<OrganizationQuickView.Attributes,OrganizationQuickView.Tabs,OrganizationQuickView.Controls> {
