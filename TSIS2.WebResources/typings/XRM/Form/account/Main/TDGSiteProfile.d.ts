declare namespace Form.account.Main {
  namespace TDGSiteProfile {
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "ClassDivision_ofDG"): Xrm.SubGridControl<"qm_tylegislationcharacteristic">;
      get(name: "Contacts"): Xrm.SubGridControl<"contact">;
      get(name: "DocumentsSubGrid"): Xrm.SubGridControl<"sharepointdocument">;
      get(name: "HOTI_Type"): Xrm.SubGridControl<"qm_tylegislationcharacteristic">;
      get(name: "MOC_FacilityType"): Xrm.SubGridControl<"qm_tylegislationcharacteristic">;
      get(name: "MOC_Type"): Xrm.SubGridControl<"qm_tylegislationcharacteristic">;
      get(name: "Modes"): Xrm.SubGridControl<"qm_tylegislationcharacteristic">;
      get(name: "SizeMeansContainment"): Xrm.SubGridControl<"qm_tylegislationcharacteristic">;
      get(name: "UN_Numbers"): Xrm.SubGridControl<"qm_tylegislationcharacteristic">;
  ...
  interface TDGSiteProfile extends Xrm.PageBase<TDGSiteProfile.Attributes,TDGSiteProfile.Tabs,TDGSiteProfile.Controls> {
    ...
    getControl(controlName: "ClassDivision_ofDG"): Xrm.SubGridControl<"qm_tylegislationcharacteristic">;
    ...
    getControl(controlName: "HOTI_Type"): Xrm.SubGridControl<"qm_tylegislationcharacteristic">;
    getControl(controlName: "MOC_FacilityType"): Xrm.SubGridControl<"qm_tylegislationcharacteristic">;
    getControl(controlName: "MOC_Type"): Xrm.SubGridControl<"qm_tylegislationcharacteristic">;
    getControl(controlName: "Modes"): Xrm.SubGridControl<"qm_tylegislationcharacteristic">;
    getControl(controlName: "SizeMeansContainment"): Xrm.SubGridControl<"qm_tylegislationcharacteristic">;
    getControl(controlName: "UN_Numbers"): Xrm.SubGridControl<"qm_tylegislationcharacteristic">;
