declare namespace Form.ts_workordercreationwizard.Main {
  namespace Information {
    ...
    interface Attributes extends Xrm.AttributeCollectionBase {
      ...
      get(name: "ts_operationtypeid"): Xrm.LookupAttribute<"msdyn_customerassetcategory">;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "ts_operationtypeid"): Xrm.LookupControl<"msdyn_customerassetcategory">;
  ...
  interface Information extends Xrm.PageBase<Information.Attributes,Information.Tabs,Information.Controls> {
    ...
    getAttribute(attributeName: "ts_operationtypeid"): Xrm.LookupAttribute<"msdyn_customerassetcategory">;
    ...
    getControl(controlName: "ts_operationtypeid"): Xrm.LookupControl<"msdyn_customerassetcategory">;
