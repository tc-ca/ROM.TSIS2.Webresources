declare namespace Form.ovs_sitetype.Main {
  namespace TCSiteTypes {
    namespace Tabs {
    }
  ...
  interface TCSiteTypes extends Xrm.PageBase<TCSiteTypes.Attributes,TCSiteTypes.Tabs,TCSiteTypes.Controls> {
