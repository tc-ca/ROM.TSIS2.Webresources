declare namespace Form.bookableresource.Main {
  namespace TDGInspectors {
    namespace Tabs {
      ...
      interface e37f45244a6642dc974c078756aef3fb extends Xrm.SectionCollectionBase {
        ...
        get(name: "General Section"): Xrm.PageSection;
        get(name: "tab_4_section_1"): Xrm.PageSection;
        get(name: "{9e7dec57-2c62-4d5d-8b21-75d076c5d1a1}"): Xrm.PageSection;
        get(name: "{e37f4524-4a66-42dc-974c-078756aef3fb}_section_4"): Xrm.PageSection;
        get(name: string): undefined;
        get(): Xrm.PageSection[];
        get(index: number): Xrm.PageSection;
        get(chooser: (item: Xrm.PageSection, index: number) => boolean): Xrm.PageSection[];
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "resource_territories_subgrid"): Xrm.SubGridControl<"msdyn_resourceterritory">;
  ...
  interface TDGInspectors extends Xrm.PageBase<TDGInspectors.Attributes,TDGInspectors.Tabs,TDGInspectors.Controls> {
    ...
    getControl(controlName: "resource_territories_subgrid"): Xrm.SubGridControl<"msdyn_resourceterritory">;
