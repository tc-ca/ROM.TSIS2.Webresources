declare namespace Form.bookableresource.Main {
  namespace AddEditInspectorForm {
    namespace Tabs {
  ...
  interface AddEditInspectorForm extends Xrm.PageBase<AddEditInspectorForm.Attributes,AddEditInspectorForm.Tabs,AddEditInspectorForm.Controls> {
