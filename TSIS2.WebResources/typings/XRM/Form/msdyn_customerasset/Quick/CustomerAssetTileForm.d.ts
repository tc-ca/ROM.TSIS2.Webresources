declare namespace Form.msdyn_customerasset.Quick {
  namespace CustomerAssetTileForm {
    namespace Tabs {
  ...
  interface CustomerAssetTileForm extends Xrm.PageBase<CustomerAssetTileForm.Attributes,CustomerAssetTileForm.Tabs,CustomerAssetTileForm.Controls> {
