declare namespace Form.ts_operationactivity.Main {
  namespace Information {
    ...
    interface Attributes extends Xrm.AttributeCollectionBase {
      ...
      get(name: "ts_duedate"): Xrm.LookupAttribute<"tc_tcfiscalquarter">;
      get(name: "ts_lastcompletedwo"): Xrm.LookupAttribute<"tc_tcfiscalquarter">;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "ts_duedate"): Xrm.LookupControl<"tc_tcfiscalquarter">;
      get(name: "ts_lastcompletedwo"): Xrm.LookupControl<"tc_tcfiscalquarter">;
      get(name: "ts_name"): Xrm.StringControl;
      get(name: "ts_nextplannedwo"): Xrm.LookupControl<"tc_tcfiscalquarter">;
      get(name: "ts_operation"): Xrm.LookupControl<"ovs_operation">;
      get(name: "ts_recurrencefrequency"): Xrm.LookupControl<"ts_recurrencefrequencies">;
  ...
  interface Information extends Xrm.PageBase<Information.Attributes,Information.Tabs,Information.Controls> {
    ...
    getAttribute(attributeName: "ts_duedate"): Xrm.LookupAttribute<"tc_tcfiscalquarter">;
    getAttribute(attributeName: "ts_lastcompletedwo"): Xrm.LookupAttribute<"tc_tcfiscalquarter">;
    ...
    getControl(controlName: "ts_duedate"): Xrm.LookupControl<"tc_tcfiscalquarter">;
    getControl(controlName: "ts_lastcompletedwo"): Xrm.LookupControl<"tc_tcfiscalquarter">;
    getControl(controlName: "ts_name"): Xrm.StringControl;
    getControl(controlName: "ts_nextplannedwo"): Xrm.LookupControl<"tc_tcfiscalquarter">;
    getControl(controlName: "ts_operation"): Xrm.LookupControl<"ovs_operation">;
    getControl(controlName: "ts_recurrencefrequency"): Xrm.LookupControl<"ts_recurrencefrequencies">;
