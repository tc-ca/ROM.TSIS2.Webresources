  ...
  namespace ROM20 {
    namespace Tabs {
      ...
      interface tab_workspace extends Xrm.SectionCollectionBase {
        get(name: "workspace_section_contact"): Xrm.PageSection;
        get(name: "workspace_section_interactions"): Xrm.PageSection;
        get(name: "workspace_section_risk"): Xrm.PageSection;
        get(name: string): undefined;
        get(): Xrm.PageSection[];
        get(index: number): Xrm.PageSection;
        get(chooser: (item: Xrm.PageSection, index: number) => boolean): Xrm.PageSection[];
