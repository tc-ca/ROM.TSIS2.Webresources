declare namespace Form.businessunit.Main {
  namespace TeamInformation {
    ...
    interface Attributes extends Xrm.AttributeCollectionBase {
      ...
      get(name: "msdyn_team"): Xrm.LookupAttribute<"team">;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "msdyn_team"): Xrm.LookupControl<"team">;
  ...
  interface TeamInformation extends Xrm.PageBase<TeamInformation.Attributes,TeamInformation.Tabs,TeamInformation.Controls> {
    ...
    getAttribute(attributeName: "msdyn_team"): Xrm.LookupAttribute<"team">;
    ...
    getControl(controlName: "msdyn_team"): Xrm.LookupControl<"team">;
