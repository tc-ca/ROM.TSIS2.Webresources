declare namespace Form.msdyn_workorder.Quick {
  namespace WorkOrderFindingQuickView {
    namespace Tabs {
  ...
  interface WorkOrderFindingQuickView extends Xrm.PageBase<WorkOrderFindingQuickView.Attributes,WorkOrderFindingQuickView.Tabs,WorkOrderFindingQuickView.Controls> {
