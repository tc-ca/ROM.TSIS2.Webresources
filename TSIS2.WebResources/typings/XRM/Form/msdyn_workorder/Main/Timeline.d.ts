declare namespace Form.msdyn_workorder.Main {
  namespace Timeline {
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "msdyn_systemstatus1"): Xrm.OptionSetControl<msdyn_wosystemstatus>;
      get(name: "msdyn_systemstatus2"): Xrm.OptionSetControl<msdyn_wosystemstatus>;
  ...
  interface Timeline extends Xrm.PageBase<Timeline.Attributes,Timeline.Tabs,Timeline.Controls> {
    ...
    getControl(controlName: "msdyn_systemstatus1"): Xrm.OptionSetControl<msdyn_wosystemstatus>;
    getControl(controlName: "msdyn_systemstatus2"): Xrm.OptionSetControl<msdyn_wosystemstatus>;
