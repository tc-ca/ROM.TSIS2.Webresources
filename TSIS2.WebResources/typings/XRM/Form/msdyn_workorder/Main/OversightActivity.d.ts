declare namespace Form.msdyn_workorder.Main {
  ...
  interface OversightActivity extends Xrm.PageBase<OversightActivity.Attributes,OversightActivity.Tabs,OversightActivity.Controls> {
