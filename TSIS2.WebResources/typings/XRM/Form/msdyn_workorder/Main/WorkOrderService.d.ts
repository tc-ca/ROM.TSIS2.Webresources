declare namespace Form.msdyn_workorder.Main {
  namespace WorkOrderService {
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "FsWorkOrderResolutionsGrid"): Xrm.SubGridControl<"msdyn_workorderresolution">;
      ...
      get(name: "workorder_KASubgrid"): Xrm.SubGridControl<"knowledgearticle">;
      get(name: string): undefined;
      get(): Xrm.BaseControl[];
  ...
  interface WorkOrderService extends Xrm.PageBase<WorkOrderService.Attributes,WorkOrderService.Tabs,WorkOrderService.Controls> {
    ...
    getControl(controlName: "FsWorkOrderResolutionsGrid"): Xrm.SubGridControl<"msdyn_workorderresolution">;
    ...
    getControl(controlName: "workorder_KASubgrid"): Xrm.SubGridControl<"knowledgearticle">;
