declare namespace Form.msdyn_workorder.Main {
  namespace WorkOrderNotes {
    namespace Tabs {
      ...
      interface fstab_notes extends Xrm.SectionCollectionBase {
        get(name: "fstab_notes_section_details"): Xrm.PageSection;
        get(name: "fstab_notes_section_summary"): Xrm.PageSection;
        get(name: string): undefined;
        get(): Xrm.PageSection[];
        get(index: number): Xrm.PageSection;
        get(chooser: (item: Xrm.PageSection, index: number) => boolean): Xrm.PageSection[];
  ...
  interface WorkOrderNotes extends Xrm.PageBase<WorkOrderNotes.Attributes,WorkOrderNotes.Tabs,WorkOrderNotes.Controls> {
