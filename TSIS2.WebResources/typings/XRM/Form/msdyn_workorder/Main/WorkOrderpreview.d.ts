declare namespace Form.msdyn_workorder.Main {
  namespace WorkOrderpreview {
    namespace Tabs {
      interface KnowledgeArticlesTab extends Xrm.SectionCollectionBase {
        get(name: "KnowledgeArticlesTab_section_3"): Xrm.PageSection;
        get(name: "KnowledgeArticlesTab_section_4"): Xrm.PageSection;
      ...
      interface b8e326ee5c214a18ba55e3b56966c249 extends Xrm.SectionCollectionBase {
        ...
        get(name: "copilot_recap_section"): Xrm.PageSection;
      ...
      interface lineitems_tab extends Xrm.SectionCollectionBase {
        get(name: "lineitems_tab_section_3"): Xrm.PageSection;
      ...
      interface tasks_tab extends Xrm.SectionCollectionBase {
        get(name: "tasksAtAGlanceSection"): Xrm.PageSection;
        get(name: "tasksGridSection"): Xrm.PageSection;
        get(name: string): undefined;
        get(): Xrm.PageSection[];
        get(index: number): Xrm.PageSection;
        get(chooser: (item: Xrm.PageSection, index: number) => boolean): Xrm.PageSection[];
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      get(name: "TeachingBubbleFormControl"): Xrm.BaseControl;
      get(name: "cc_1679607469845"): Xrm.BaseControl;
      get(name: "cc_1680711963371"): Xrm.BaseControl;
      get(name: "cc_1680711988813"): Xrm.BaseControl;
      get(name: "cc_1680711993115"): Xrm.BaseControl;
      ...
      get(name: "msdyn_costntepercent1"): Xrm.Control<Xrm.Attribute<any>>;
      ...
      get(name: "msdyn_systemstatus2"): Xrm.Control<Xrm.Attribute<any>>;
      ...
      get(name: "tasksAtAGlanceCard"): Xrm.BaseControl;
      get(name: "tasksGrid"): Xrm.BaseControl;
    ...
    interface Tabs extends Xrm.TabCollectionBase {
      ...
      get(name: "lineitems_tab"): Xrm.PageTab<Tabs.lineitems_tab>;
      get(name: "tab_12"): Xrm.PageTab<Tabs.tab_12>;
      get(name: "tasks_tab"): Xrm.PageTab<Tabs.tasks_tab>;
      get(name: string): undefined;
  ...
  interface WorkOrderpreview extends Xrm.PageBase<WorkOrderpreview.Attributes,WorkOrderpreview.Tabs,WorkOrderpreview.Controls> {
    ...
    getControl(controlName: "TeachingBubbleFormControl"): Xrm.BaseControl;
    getControl(controlName: "cc_1679607469845"): Xrm.BaseControl;
    getControl(controlName: "cc_1680711963371"): Xrm.BaseControl;
    getControl(controlName: "cc_1680711988813"): Xrm.BaseControl;
    getControl(controlName: "cc_1680711993115"): Xrm.BaseControl;
    ...
    getControl(controlName: "msdyn_costntepercent1"): Xrm.Control<Xrm.Attribute<any>>;
    ...
    getControl(controlName: "msdyn_systemstatus2"): Xrm.Control<Xrm.Attribute<any>>;
    ...
    getControl(controlName: "tasksAtAGlanceCard"): Xrm.BaseControl;
    getControl(controlName: "tasksGrid"): Xrm.BaseControl;
