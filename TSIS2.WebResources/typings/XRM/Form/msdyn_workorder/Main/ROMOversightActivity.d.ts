declare namespace Form.msdyn_workorder.Main {
  namespace ROMOversightActivity {
    namespace Tabs {
      ...
      interface Workspace_Tab extends Xrm.SectionCollectionBase {
        get(name: "AircraftDetails"): Xrm.PageSection;
        get(name: "FlightDetails"): Xrm.PageSection;
        get(name: "tab_15_section_2"): Xrm.PageSection;
        get(name: string): undefined;
        get(): Xrm.PageSection[];
        get(index: number): Xrm.PageSection;
        get(chooser: (item: Xrm.PageSection, index: number) => boolean): Xrm.PageSection[];
      ...
      interface b8e326ee5c214a18ba55e3b56966c249 extends Xrm.SectionCollectionBase {
        ...
        get(name: "{b8e326ee-5c21-4a18-ba55-e3b56966c249}_section_14"): Xrm.PageSection;
      ...
      interface work_order_document_tab extends Xrm.SectionCollectionBase {
        get(name: "tab_14_section_3"): Xrm.PageSection;
        get(name: "work_order_document_section"): Xrm.PageSection;
        get(name: string): undefined;
        get(): Xrm.PageSection[];
        get(index: number): Xrm.PageSection;
        get(chooser: (item: Xrm.PageSection, index: number) => boolean): Xrm.PageSection[];
    ...
    interface Attributes extends Xrm.AttributeCollectionBase {
      ...
      get(name: "msdyn_followupnote"): Xrm.Attribute<string>;
      get(name: "msdyn_followuprequired"): Xrm.OptionSetAttribute<boolean>;
      ...
      get(name: "msdyn_isfollowup"): Xrm.OptionSetAttribute<boolean>;
      ...
      get(name: "ts_actualtimeofarrival"): Xrm.DateAttribute;
      get(name: "ts_actualtimeofdeparture"): Xrm.DateAttribute;
      get(name: "ts_aircraftclassification"): Xrm.OptionSetAttribute<ts_aircraftclassification>;
      get(name: "ts_aircraftregistration"): Xrm.Attribute<string>;
      ...
      get(name: "ts_checkedbagscheckedin"): Xrm.NumberAttribute;
      ...
      get(name: "ts_registration"): Xrm.LookupAttribute<"ts_aircraft">;
      ...
      get(name: "ts_scheduledtimeofarrival"): Xrm.DateAttribute;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "msdyn_followupnote"): Xrm.StringControl;
      get(name: "msdyn_followupnote1"): Xrm.StringControl;
      get(name: "msdyn_followuprequired"): Xrm.OptionSetControl<boolean>;
      ...
      get(name: "msdyn_isfollowup"): Xrm.OptionSetControl<boolean>;
      ...
      get(name: "msdyn_servicerequest1"): Xrm.LookupControl<"incident">;
      ...
      get(name: "ts_checkedbagscheckedin"): Xrm.NumberControl;
      ...
      get(name: "ts_departureaerodrome"): Xrm.LookupControl<"msdyn_functionallocation">;
      ...
      get(name: "ts_registration"): Xrm.LookupControl<"ts_aircraft">;
      ...
      get(name: "ts_scheduledtimeofarrival"): Xrm.DateControl;
      get(name: "ts_scheduledtimeofdeparture"): Xrm.DateControl;
    ...
    interface Tabs extends Xrm.TabCollectionBase {
      ...
      get(name: "Workspace_Tab"): Xrm.PageTab<Tabs.Workspace_Tab>;
      ...
      get(name: "work_order_document_tab"): Xrm.PageTab<Tabs.work_order_document_tab>;
      get(name: string): undefined;
  ...
  interface ROMOversightActivity extends Xrm.PageBase<ROMOversightActivity.Attributes,ROMOversightActivity.Tabs,ROMOversightActivity.Controls> {
    ...
    getAttribute(attributeName: "msdyn_followupnote"): Xrm.Attribute<string>;
    getAttribute(attributeName: "msdyn_followuprequired"): Xrm.OptionSetAttribute<boolean>;
    ...
    getAttribute(attributeName: "msdyn_isfollowup"): Xrm.OptionSetAttribute<boolean>;
    ...
    getAttribute(attributeName: "ts_actualtimeofarrival"): Xrm.DateAttribute;
    getAttribute(attributeName: "ts_actualtimeofdeparture"): Xrm.DateAttribute;
    getAttribute(attributeName: "ts_aircraftclassification"): Xrm.OptionSetAttribute<ts_aircraftclassification>;
    getAttribute(attributeName: "ts_aircraftregistration"): Xrm.Attribute<string>;
    ...
    getAttribute(attributeName: "ts_checkedbagscheckedin"): Xrm.NumberAttribute;
    ...
    getAttribute(attributeName: "ts_registration"): Xrm.LookupAttribute<"ts_aircraft">;
    ...
    getAttribute(attributeName: "ts_scheduledtimeofarrival"): Xrm.DateAttribute;
    ...
    getControl(controlName: "msdyn_followupnote"): Xrm.StringControl;
    getControl(controlName: "msdyn_followupnote1"): Xrm.StringControl;
    getControl(controlName: "msdyn_followuprequired"): Xrm.OptionSetControl<boolean>;
    ...
    getControl(controlName: "msdyn_isfollowup"): Xrm.OptionSetControl<boolean>;
    ...
    getControl(controlName: "msdyn_servicerequest1"): Xrm.LookupControl<"incident">;
    ...
    getControl(controlName: "ts_checkedbagscheckedin"): Xrm.NumberControl;
    ...
    getControl(controlName: "ts_departureaerodrome"): Xrm.LookupControl<"msdyn_functionallocation">;
    ...
    getControl(controlName: "ts_registration"): Xrm.LookupControl<"ts_aircraft">;
    ...
    getControl(controlName: "ts_scheduledtimeofarrival"): Xrm.DateControl;
    getControl(controlName: "ts_scheduledtimeofdeparture"): Xrm.DateControl;
