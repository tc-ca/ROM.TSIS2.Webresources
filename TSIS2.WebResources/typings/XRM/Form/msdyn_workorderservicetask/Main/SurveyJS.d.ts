declare namespace Form.msdyn_workorderservicetask.Main {
  namespace SurveyJS {
    ...
    interface Attributes extends Xrm.AttributeCollectionBase {
      ...
      get(name: "ts_boardinglounge"): Xrm.LookupAttribute<"msdyn_functionallocation">;
      ...
      get(name: "ts_gate"): Xrm.LookupAttribute<"msdyn_functionallocation">;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "ts_boardinglounge"): Xrm.LookupControl<"msdyn_functionallocation">;
      ...
      get(name: "ts_gate"): Xrm.LookupControl<"msdyn_functionallocation">;
  ...
  interface SurveyJS extends Xrm.PageBase<SurveyJS.Attributes,SurveyJS.Tabs,SurveyJS.Controls> {
    ...
    getAttribute(attributeName: "ts_boardinglounge"): Xrm.LookupAttribute<"msdyn_functionallocation">;
    ...
    getAttribute(attributeName: "ts_gate"): Xrm.LookupAttribute<"msdyn_functionallocation">;
    ...
    getControl(controlName: "ts_boardinglounge"): Xrm.LookupControl<"msdyn_functionallocation">;
    ...
    getControl(controlName: "ts_gate"): Xrm.LookupControl<"msdyn_functionallocation">;
