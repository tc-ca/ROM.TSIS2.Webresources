declare namespace Form.msdyn_workorderservicetask.Main {
  namespace TDGServiceTaskQuestionnaire {
    namespace Tabs {
    ...
    interface Attributes extends Xrm.AttributeCollectionBase {
      ...
      get(name: "ovs_isquestionnairecomplete"): Xrm.OptionSetAttribute<boolean>;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "ovs_isquestionnairecomplete"): Xrm.OptionSetControl<boolean>;
  ...
  interface TDGServiceTaskQuestionnaire extends Xrm.PageBase<TDGServiceTaskQuestionnaire.Attributes,TDGServiceTaskQuestionnaire.Tabs,TDGServiceTaskQuestionnaire.Controls> {
    ...
    getAttribute(attributeName: "ovs_isquestionnairecomplete"): Xrm.OptionSetAttribute<boolean>;
    ...
    getControl(controlName: "ovs_isquestionnairecomplete"): Xrm.OptionSetControl<boolean>;
