declare namespace Form.systemuser.Main {
  namespace UserInformationForm {
    namespace Tabs {
      interface UserInfoTab extends Xrm.SectionCollectionBase {
    ...
    interface Tabs extends Xrm.TabCollectionBase {
      get(name: "UserInfoTab"): Xrm.PageTab<Tabs.UserInfoTab>;
      get(name: string): undefined;
  ...
  interface UserInformationForm extends Xrm.PageBase<UserInformationForm.Attributes,UserInformationForm.Tabs,UserInformationForm.Controls> {
