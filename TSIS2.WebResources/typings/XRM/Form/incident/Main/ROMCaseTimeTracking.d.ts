declare namespace Form.incident.Main {
  ...
  interface ROMCaseTimeTracking extends Xrm.PageBase<ROMCaseTimeTracking.Attributes,ROMCaseTimeTracking.Tabs,ROMCaseTimeTracking.Controls> {
