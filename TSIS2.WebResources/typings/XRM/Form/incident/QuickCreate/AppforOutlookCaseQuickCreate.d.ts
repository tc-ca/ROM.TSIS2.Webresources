declare namespace Form.incident.QuickCreate {
  namespace AppforOutlookCaseQuickCreate {
    namespace Tabs {
  ...
  interface AppforOutlookCaseQuickCreate extends Xrm.PageBase<AppforOutlookCaseQuickCreate.Attributes,AppforOutlookCaseQuickCreate.Tabs,AppforOutlookCaseQuickCreate.Controls> {
