declare namespace Form.contact.Quick {
  ...
  interface ContactQuickViewTC extends Xrm.PageBase<ContactQuickViewTC.Attributes,ContactQuickViewTC.Tabs,ContactQuickViewTC.Controls> {
