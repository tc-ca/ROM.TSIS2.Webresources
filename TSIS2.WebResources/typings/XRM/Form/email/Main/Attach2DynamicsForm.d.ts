declare namespace Form.email.Main {
  ...
  interface Attach2DynamicsForm extends Xrm.PageBase<Attach2DynamicsForm.Attributes,Attach2DynamicsForm.Tabs,Attach2DynamicsForm.Controls> {
