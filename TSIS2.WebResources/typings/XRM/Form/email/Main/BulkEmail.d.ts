declare namespace Form.email.Main {
  namespace BulkEmail {
    namespace Tabs {
      interface Email extends Xrm.SectionCollectionBase {
        get(name: "Email_MainSection"): Xrm.PageSection;
        get(name: "Email_PreviewSection"): Xrm.PageSection;
      ...
      interface Email_Engagement extends Xrm.SectionCollectionBase {
        get(name: "Email_Engagement_column_3_section_1"): Xrm.PageSection;
    ...
    interface Controls extends Xrm.ControlCollectionBase {
      ...
      get(name: "msdyn_recipientlist"): Xrm.StringControl;
      get(name: "previewdescription"): Xrm.Control<Xrm.Attribute<any>>;
      get(name: "previewsubject"): Xrm.StringControl;
  ...
  interface BulkEmail extends Xrm.PageBase<BulkEmail.Attributes,BulkEmail.Tabs,BulkEmail.Controls> {
    ...
    getAttribute(attributeName: "msdyn_recipientlist"): Xrm.Attribute<string>;
    ...
    getControl(controlName: "msdyn_recipientlist"): Xrm.StringControl;
    getControl(controlName: "previewdescription"): Xrm.Control<Xrm.Attribute<any>>;
    getControl(controlName: "previewsubject"): Xrm.StringControl;
