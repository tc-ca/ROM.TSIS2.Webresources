    ...
    export function onLoad(eContext: Xrm.ExecutionContext<any, any>): void {
        ...
        Xrm.WebApi.retrieveMultipleRecords("businessunit", currentUserBusinessUnitFetchXML).then(function (result) {
            ...
            if(!(userBusinessUnitName.startsWith("Transport"))){
                ...
                const layoutXmlActivity = '<grid name="resultset" object="10010" jump="ovs_name" select="1" icon="1" preview="1"><row name="result" id="ovs_operationid"><cell name="ovs_name" width="200" /></row></grid>';
                const fetchXmlActivity = '<fetch version="1.0" mapping="logical"><entity name="ovs_operation"><filter type="and"><condition attribute="statecode" operator="eq" value="0"/></filter><attribute name="ovs_operationid"/><attribute name="ovs_name"/><order attribute="ovs_name"/><link-entity name="businessunit" from="businessunitid" to="owningbusinessunit"><attribute name="name"/><filter><condition attribute="name" operator="like" value="' + userBusinessUnitName.substring(0,5) + '%"/></filter></link-entity></entity></fetch>';
