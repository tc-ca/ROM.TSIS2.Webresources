    ...
    export function onLoad(eContext: Xrm.ExecutionContext<any, any>): void {
        ...
        Xrm.WebApi.retrieveMultipleRecords("businessunit", currentUserBusinessUnitFetchXML).then(function (result) {
            ...
            if(!(userBusinessUnitName.startsWith("Transport"))){
                ...
                const layoutXmlActivity = '<grid name="resultset" object="10010" jump="ovs_name" select="1" icon="1" preview="1"><row name="result" id="ovs_operationid"><cell name="ovs_name" width="200" /><cell name="ts_stakeholder" width="200" /><cell name="ovs_operationtypeid" width="200" /><cell name="ts_site" width="200" /></row></grid>';
