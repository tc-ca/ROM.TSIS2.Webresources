...
declare function assignUserTeamOwnershipOnSave(formContext: any): Promise<boolean>;
declare function logCurrentTeamOwnershipStatus(formContext: any): Promise<void>;
