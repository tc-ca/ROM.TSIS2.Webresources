...
namespace ROM.Case {
    ...
    export function onLoad(eContext: Xrm.ExecutionContext<any, any>): void {
        const form = <Form.ts_case.Main.Information>eContext.getFormContext();
    ...
    export function systemStatusCodeOnChange(eContext: Xrm.ExecutionContext<any, any>): void {
        const form = <Form.ts_case.Main.Information>eContext.getFormContext();
        //if(form.getAttribute("header_statuscode").getValue() == 7){
        //}
    }
    ...
    export function regionOnChange(eContext: Xrm.ExecutionContext<any, any>): void {
        try {
            ...
            if (regionAttribute != null && regionAttribute != undefined) {
                ...
                if (!form.getControl("ts_customer").getDisabled() || form.getAttribute("ts_customer").getValue() != null) {
                    form.getAttribute("ts_customer").setValue(null);
                }
    ...
    function setCountryFilteredView(form: Form.ts_case.Main.Information): void {
    ...
    function setWorkOrder1FilteredView(form: Form.ts_case.Main.Information): void {
    ...
    function setWorkOrder2FilteredView(form: Form.ts_case.Main.Information): void {
        const caseId = form.data.entity.getId();
    ...
    function setWOST1FilteredView(form: Form.ts_case.Main.Information): void {
        //const WorkOrderValue = form.getAttribute("ts_workorder1").getValue()
    ...
    function setWOST2FilteredView(form: Form.ts_case.Main.Information): void {
        //const WorkOrderValue = form.getAttribute("ts_workorder2").getValue()
        //const workOrderId = (WorkOrderValue != null) ? WorkOrderValue[0].id : null
    ...
    function setAdditionalInspectors1FilteredView(form: Form.ts_case.Main.Information): void {
        //const WorkOrderValue = form.getAttribute("ts_workorder1").getValue()
        //const workOrderId = (WorkOrderValue != null) ? WorkOrderValue[0].id : null
    ...
    function setAdditionalInspectors2FilteredView(form: Form.ts_case.Main.Information): void {
        //const WorkOrderValue = form.getAttribute("ts_workorder2").getValue()
        //const workOrderId = (WorkOrderValue != null) ? WorkOrderValue[0].id : null
