...
namespace ROM.WorkOrder {
            ...
            if (regionAttribute != null && regionAttribute != undefined) {
                ...
                if (regionAttributeValue != null && regionAttributeValue != undefined) {
                    ...
                    if (regionAttributeValue[0].name != "International") {
                        ...
                        // Setup a custom view
                        // This value is never saved and only needs to be unique among the other available views for the lookup.
                        const viewId = '{145AC9F2-4F7E-43DF-BEBD-442CB4C1F661}';
    ...
    export function updateCaseView(eContext: Xrm.ExecutionContext<any, any>): void {
        try {
            ...
            var stakeholderCondition = stakeholderAttributeValue == null ? "" : '<condition attribute="ovs_regulatedentity" operator="eq" value="' + stakeholderAttributeValue[0].id + '" />';
