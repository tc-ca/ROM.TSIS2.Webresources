export default class MainForm {
  ...
  // FUNCTIONS
  private static setRegion(eContext: Xrm.ExecutionContext<any, any>): void {
    var currentUserId = Xrm.Utility.getGlobalContext().userSettings.userId;
    currentUserId = currentUserId.replace(/[{}]/g, "");

    // Get the user's territory
    const $this = this; // MainForm
  ...
  private static setCountryFilteredView = function (form: Form.incident.Main.ROMCase): void {
