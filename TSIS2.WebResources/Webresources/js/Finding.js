...
(function (ROM) {
    ...
    (function (Finding) {
        ...
        function onLoad(eContext) {
            ...
            var complianceFindingType = formContext.getAttribute("ts_findingtype").getValue() == ts_findingtype.Noncompliance;
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            onLoad(eContext);
                            if (statusCodeValue == ovs_finding_statuscode.Complete)
                                return [2 /*return*/];
                            acceptNCATRecommendation = formContext.getAttribute("ts_acceptncatrecommendation").getValue();
                            acceptRATERecommendation = formContext.getAttribute("ts_acceptraterecommendation").getValue();
                            rejectedRecommendation = (acceptNCATRecommendation == ts_yesno.No || acceptRATERecommendation == ts_yesno.No);
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            thresholdsPromise = Xrm.WebApi.retrieveMultipleRecords("ts_assessmentscorethredshots", "?$select=ts_minimum,ts_maximum,ts_ncatenforcementaction&$filter=ts_assessmenttool eq ".concat(ts_assessmenttool.NCAT));
