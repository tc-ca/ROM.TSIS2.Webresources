...
<<<<<<< HEAD
  ...
  var incidentTypeOwnerFetchXML = [
    ...
    "    <filter>",
    "      <condition attribute='msdyn_incidenttypeid' operator='eq' value='",
    incidentTypeId,
    "'/>",
    "    </filter>",
  ...
  Xrm.WebApi.retrieveMultipleRecords("msdyn_incidenttype", incidentTypeOwnerFetchXML).then(async function (result) {
    const incidentTypeOwnerId = result.entities[0]["team.teamid"];
    ...
    if (incidentTypeOwnerId && aviationBuGuid && incidentTypeOwnerId.toLowerCase() === aviationBuGuid.toLowerCase()) {
