...
(function (ROM) {
    ...
    (function (UnplannedWorkOrder) {
        ...
        function onLoad(eContext) {
            ...
            Xrm.WebApi.retrieveMultipleRecords("businessunit", currentUserBusinessUnitFetchXML).then(function (businessunit) {
                return __awaiter(this, void 0, void 0, function () {
                    var userBU, userBusinessUnitId, isAvSec;
            ...
            try {
                ...
                if (siteAttribute != null && siteAttribute != undefined && subSiteAttribute != null && subSiteAttribute != undefined) {
                    ...
                    if (siteAttributeValue != null && siteAttributeValue != undefined &&
                        ...
                        // Populate operation asset
                        var fetchXml = '<fetch version="1.0" output-format="xml-platform" mapping="logical" distinct="false"><entity name="ovs_operation"><attribute name="ovs_name"/><attribute name="ts_stakeholder"/><attribute name="ts_site"/><attribute name="ovs_operationid"/><attribute name="ts_operationalstatus"/><order attribute="ovs_name" descending="true"/><filter type="and"><condition attribute="statecode" operator="eq" value="0"/><condition attribute="ovs_operationtypeid" operator="eq" value="' + operationTypeAttributeValue_2[0].id + '"/><condition attribute="ts_site" operator="eq" value="' + siteAttributeValue[0].id + '"/><condition attribute="ts_stakeholder" operator="eq" value="' + stakeholderAttributeValue[0].id + '"/><condition attribute="ts_subsite" operator="eq" value="' + subSiteAttributeValue[0].id + '"/></filter></entity></fetch>';
                        var encodedFetchXml = encodeURIComponent(fetchXml);
                        Xrm.WebApi.retrieveMultipleRecords("ovs_operation", "?fetchXml=" + encodedFetchXml).then(function success(result) {
                            if (result.entities.length == 1) {
                                var targetOperation = result.entities[0];
            ...
            try {
                ...
                if (siteAttribute != null && siteAttribute != undefined) {
                    ...
                    if (siteAttributeValue != null && siteAttributeValue != undefined &&
                        ...
                        // Populate operation asset
                        var fetchXml = '<fetch version="1.0" output-format="xml-platform" mapping="logical" distinct="false"><entity name="ovs_operation"><attribute name="ovs_name"/><attribute name="ts_stakeholder"/><attribute name="ts_site"/><attribute name="ovs_operationid"/><attribute name="ts_operationalstatus"/><order attribute="ovs_name" descending="true"/><filter type="and"><condition attribute="statecode" operator="eq" value="0"/><condition attribute="ovs_operationtypeid" operator="eq" value="' + operationTypeAttributeValue_3[0].id + '"/><condition attribute="ts_site" operator="eq" value="' + siteAttributeValue[0].id + '"/><condition attribute="ts_stakeholder" operator="eq" value="' + stakeholderAttributeValue[0].id + '"/></filter></entity></fetch>';
                        var encodedFetchXml = encodeURIComponent(fetchXml);
                        Xrm.WebApi.retrieveMultipleRecords("ovs_operation", "?fetchXml=" + encodedFetchXml).then(function success(result) {
                            if (result.entities.length == 1) {
                                var targetOperation = result.entities[0];
        ...
        function systemStatusOnChange(eContext) {
            ...
            Xrm.WebApi.retrieveMultipleRecords("businessunit", currentUserBusinessUnitFetchXML).then(function (businessunit) {
                return __awaiter(this, void 0, void 0, function () {
                    var userBU, userBusinessUnitId, woLookup, isAvSec, woId, fetchFindings;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                if (!businessunit || !businessunit.entities || businessunit.entities.length === 0) {
                                ...
                                userBU = businessunit.entities[0];
                                userBusinessUnitId = userBU.businessunitid;
                                woLookup = form.getAttribute("ts_workorder").getValue();
                                return [4 /*yield*/, isAvSecBU(userBusinessUnitId)];
                            case 1:
                                isAvSec = _a.sent();
                                if (isAvSec) {
        ...
        function setActivityTypeFilteredView(form, operationAttributeId, workOrderTypeAttributeId, operationTypeAttributeId) {
            ...
            var operationTypeIdClean = operationTypeAttributeId ? operationTypeAttributeId.replace(/[{}]/g, "") : "";
            if (!operationTypeIdClean) {
                return;
            }
            Xrm.WebApi.retrieveRecord("ovs_operationtype", operationTypeIdClean, "?$select=_owningbusinessunit_value")
                .then(function success(operationType) {
                return __awaiter(this, void 0, void 0, function () {
                    var operationActivityFilter, owningBuId, isAvSec, fetchXmlActivity, viewIdActivity, entityNameActivity, viewDisplayNameActivity, layoutXmlActivity;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                operationActivityFilter = "";
                                if (!(!isFromSecurityIncident && operationType && operationType._owningbusinessunit_value)) return [3 /*break*/, 2];
                                owningBuId = operationType._owningbusinessunit_value;
                            ...
                            case 2:
                                ...
                                viewDisplayNameActivity = Xrm.Utility.getResourceString("ts_/resx/UnplannedWorkOrder", "FilteredActivityType");
        ...
        function showFindingsFieldIfRailSafetyApp(form, isRailSafetyApp, eContext) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    try {
                        if (isRailSafetyApp) {
                            parentWOAttribute = form.getAttribute("ts_parentworkorder");
