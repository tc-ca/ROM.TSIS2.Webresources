...
(function (ROM) {
    ...
    (function (Case) {
                ...
                Xrm.WebApi.retrieveMultipleRecords("businessunit", operationTypeOwningBusinessUnitFetchXML).then(function success(resultBusinessUnit) {
                    return __awaiter(this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    if (!(resultBusinessUnit.entities.length > 0)) return [3 /*break*/, 2];
                                    buId = resultBusinessUnit.entities[0].businessunitid;
        ...
        Case.systemStatusCodeOnChange = systemStatusCodeOnChange;
        ...
        Case.regionOnChange = regionOnChange;
        ...
        Case.countryOnChange = countryOnChange;
        ...
        Case.stakeholderOnChange = stakeholderOnChange;
        ...
        Case.tradenameOnChange = tradenameOnChange;
        // FUNCTIONS
        ...
        Case.workOrder1OnChange = workOrder1OnChange;
        ...
        Case.workOrder2OnChange = workOrder2OnChange;
        ...
        Case.workOrderServiceTask1OnChange = workOrderServiceTask1OnChange;
        ...
        Case.workOrderServiceTask2OnChange = workOrderServiceTask2OnChange;
