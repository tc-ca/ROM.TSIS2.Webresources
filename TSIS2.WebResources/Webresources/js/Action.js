...
(function (ROM) {
    ...
    (function (Action) {
        ...
        function actionCategoryOnChange(eContext) {
            ...
            else if (actionCategoryAttributeValue == 741130001 /* ts_actioncategory.CorrectiveAction */ && actionTypeAttributeValue == 741130008 /* ts_actiontype.CorrectiveActionPlan */) {
                form.getControl("ts_stakeholder").setVisible(true);
                form.getControl("ts_contact").setVisible(true);
        ...
        function actionStatusOnChange(eContext) {
            ...
            var actionCategoryAttributeValue = form.getAttribute("ts_actioncategory").getValue();
            var actionTypeAttributeValue = form.getAttribute("ts_actiontype").getValue();
            if (!(actionStatus != null && actionTypeAttributeValue != null && actionCategoryAttributeValue == 741130001 /* ts_actioncategory.CorrectiveAction */ && actionTypeAttributeValue == 741130008 /* ts_actiontype.CorrectiveActionPlan */)) {
