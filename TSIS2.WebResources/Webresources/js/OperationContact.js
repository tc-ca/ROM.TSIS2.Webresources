        ...
        function onLoad(eContext) {
            ...
            Xrm.WebApi.retrieveMultipleRecords("businessunit", currentUserBusinessUnitFetchXML).then(function (result) {
                ...
                if (!(userBusinessUnitName.startsWith("Transport"))) {
                    ...
                    var layoutXmlActivity = '<grid name="resultset" object="10010" jump="ovs_name" select="1" icon="1" preview="1"><row name="result" id="ovs_operationid"><cell name="ovs_name" width="200" /><cell name="ts_site" width="200" /><cell name="ovs_operationtypeid" width="200" /></row></grid>';
