        ...
        function onLoad(eContext) {
            ...
            Xrm.WebApi.retrieveMultipleRecords("businessunit", currentUserBusinessUnitFetchXML).then(function (result) {
                ...
                if (!userBusinessUnitName.startsWith("Transport")) {
                    ...
                    var layoutXmlActivity = '<grid name="resultset" object="10010" jump="ovs_name" select="1" icon="1" preview="1"><row name="result" id="ovs_operationid"><cell name="ovs_name" width="200" /></row></grid>';
                    var fetchXmlActivity = '<fetch version="1.0" mapping="logical"><entity name="ovs_operation"><filter type="and"><condition attribute="statecode" operator="eq" value="0"/></filter><attribute name="ovs_operationtypeid"/><attribute name="ovs_operationid"/><order attribute="ts_site" descending="false"/><order attribute="ovs_operationtypeid" descending="false"/><order attribute="ts_stakeholder" descending="false"/><attribute name="ovs_name"/><attribute name="ownerid"/><link-entity name="businessunit" from="businessunitid" to="owningbusinessunit"><attribute name="name"/><filter><condition attribute="name" operator="like" value="' + userBusinessUnitName.substring(0, 4) + '"/></filter></link-entity></entity></fetch>';
