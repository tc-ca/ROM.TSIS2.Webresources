...
var widget = {
    ...
    afterRender: function (question, el) {
        ...
        function updateCharacterCount() {
            characterCount.innerText = (4000 - comments.value.length) + " " + charactersRemainingLocalizedText;
        }
