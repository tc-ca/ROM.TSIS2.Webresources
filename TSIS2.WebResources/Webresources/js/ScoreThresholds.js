    ...
    (function (ScoreThresholds) {
        function OnLoad(eContext) {
            ...
            if (assessmentTool != null) {
                if (assessmentTool == 717750000 /* ts_assessmenttool.NCAT */) {
        ...
        function checkScoreIntersection(Form) {
            ...
            var enforcementHistoryFetchXMLFilter = (assessmentTool == 717750001 /* ts_assessmenttool.RATE */) ? "<condition attribute='ts_rateenforcementhistory' operator = 'eq' value = '" + enforcementHistory + "'/>" : "";
            var fetchXml = [
                "<fetch>",
